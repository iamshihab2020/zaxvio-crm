...
const entries: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Start with a template. Click **New automation** on the Automations page and you'll get ten ready-made ones, grouped by what they're for:\n\n**Getting paid**\n• **Chase overdue invoices** — three reminders, gentle at 1 day, firmer at 7, direct at 14. Anyone who pays stops hearing from it.\n\n**Winning work**\n• **Follow up an accepted quote** — confirms it straight away and flags the big ones for a personal call.\n• **Chase a quote nobody answered** — one polite nudge three days on, and only if they haven't replied.\n• **Follow up a quote they opened but didn't answer** — two days after they read it, ask what they thought.\n\n**Keeping customers**\n• **Ask for a review after the job** — waits three working days after you mark a job complete, then asks.\n• **Welcome a new customer** — a short hello, so the first email they get from you isn't an invoice.\n• **Renew a service agreement before it lapses** — a month before it ends, ask them to renew.\n• **Tell customers before a warranty runs out** — two months before cover ends, offer a service plan instead.\n\n**Staying on top**\n• **Know about new bookings** — a notification the moment somebody books through your website.\n• **Remind customers before their appointment** — a short note the morning before, so fewer people forget you're coming.\n\nPick one and the panel on the right shows what it does and every step it takes, before you add anything.\n\n**Nothing sends when you add one.** It opens in the builder as a draft, switched off. Read what it will send, change any wording you like, then Publish and switch it on.\n\nEvery step can be changed or removed, and you can add your own. If you'd rather build it yourself, **Start from blank** is the first option in the same list.\n\nA template you've already added is ticked, and its panel says **Already added** — you can still add a second copy if you want two versions.",
  },
  {
